...
export default async function EmailVerificationPage(props: { searchParams: SearchParams }) {
  ...
  const success = await verifyEmail(id as string, expires as string, hash as string, signature as string);
